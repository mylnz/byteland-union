...
public class ValidationUtils {
    ...
    public static void isInputDataNotValid(int numberOfStates, List<Integer> connectedCities) throws Exception {
    ...
    public static void isTestCountNotValid(int testCount) throws Exception {
